...
plotGraph(barwidth, saveName="qs.eps", pp=pp, ignoreString="Relative", globString="queriesSize*.data", rebaseString="queriesSize(?P<base>\w*)", Ylabel="Number of queries (%)", Xlabel="Terms per query", mapType=float, N=5, barPlot=True) 
